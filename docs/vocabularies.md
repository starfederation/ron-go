...
| [Spatial](./vocabulary-spatial.md) | `https://ron.dev/vocab/spatial/v1` | `ron.Box2`, `ron.Box3`, `ron.Sphere`, `ron.Plane`, `ron.Ray`, `ron.Line2`, `ron.Line3`, `ron.Triangle`, `ron.Frustum`, `ron.SphericalHarmonics3`, `ron.VoxelSet` | Local `components/math` |
...
| [Set](./vocabulary-set.md) | `https://ron.dev/vocab/set/v1` | `ron.Set`, `ron.Uint32BitSet` | None |
