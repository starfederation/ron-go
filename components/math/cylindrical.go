...
type Cylindrical[T Float] struct {
...
func NewCylindrical[T Float](radius, theta, y T) *Cylindrical[T] {
...
func (c *Cylindrical[T]) SetFromCartesianCoords(x, y, z T) *Cylindrical[T] {
	...
	c.Radius = T(stdmath.Sqrt(xf*xf + zf*zf))
	c.Theta = T(stdmath.Atan2(xf, zf))
	c.Y = y
	return c
}
