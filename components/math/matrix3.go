...
type Matrix3[T Float] [9]T

func NewMatrix3[T Float](n11, n12, n13, n21, n22, n23, n31, n32, n33 T) *Matrix3[T] {
	return &Matrix3[T]{
		n11, n12, n13,
		n21, n22, n23,
		n31, n32, n33,
...
func NewMatrix3Identity[T Float]() *Matrix3[T] {
	m := &Matrix3[T]{}
	return m.Identity()
}
...
func MultiplyMatrices[T Float](a, b Matrix3[T]) *Matrix3[T] {
...
func (m *Matrix3[T]) SetUvTransform(tx, ty, sx, sy, rotation, cx, cy T) *Matrix3[T] {
	c := T(stdmath.Cos(float64(rotation)))
	s := T(stdmath.Sin(float64(rotation)))
