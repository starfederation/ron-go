...
type Matrix4[T Float] [16]T

func NewMatrix4[T Float](n11, n12, n13, n14, n21, n22, n23, n24, n31, n32, n33, n34, n41, n42, n43, n44 T) *Matrix4[T] {
	m := &Matrix4[T]{}
	m.Set(n11, n12, n13, n14, n21, n22, n23, n24, n31, n32, n33, n34, n41, n42, n43, n44)
	return m
}

func NewMatrix4Identity[T Float]() *Matrix4[T] {
	m := &Matrix4[T]{}
	m.Identity()
	return m
}
...
func (m *Matrix4[T]) MakeRotationFromEuler(euler Euler[T]) *Matrix4[T] {
	...
	a, b := stdmath.Cos(x), stdmath.Sin(x)
	c, d := stdmath.Cos(y), stdmath.Sin(y)
	e, f := stdmath.Cos(z), stdmath.Sin(z)
...
func MakeRotationFromQuaternion[T Float](q Quaternion[T]) *Matrix4[T] {
	m := Matrix4[T]{}
...
func MultiplyMatrice4s[T Float](a, b Matrix4[T]) *Matrix4[T] {
...
func (m *Matrix4[T]) MaxScaleOnAxis() T {
	...
	return T(stdmath.Sqrt(float64(max(scaleXSq, max(scaleYSq, scaleZSq)))))
}
...
func (m *Matrix4[T]) MakeRotationX(theta T) *Matrix4[T] {
	c := T(stdmath.Cos(float64(theta)))
	s := T(stdmath.Sin(float64(theta)))
	m.Set(
		1, 0, 0, 0,
		0, c, -s, 0,
		0, s, c, 0,
